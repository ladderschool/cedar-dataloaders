...
import type { FindMagazineQuery } from 'types/graphql'

type MagazineProps = {
  magazine: FindMagazineQuery['magazine']
}
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-shrink-0">
              <div className="w-48 h-64 bg-gradient-to-br from-red-500 to-orange-600 rounded-lg shadow-lg flex items-center justify-center">
                <div className="text-center text-white">
                  <div className="text-4xl font-bold mb-2">
                    {magazine.title.charAt(0)}
                  </div>
                  <div className="text-sm opacity-90">Magazine</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  <span className="text-gray-600 font-medium w-20">Pages:</span>
        ...
        {totalPages > 0 ? (
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="bg-gray-50 px-6 py-3 border-t border-gray-200">
              <div className="text-center text-sm text-gray-500">
                Article {currentPageIndex + 1} of {totalPages}
              </div>
            </div>
          </div>
        ) : (
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600">
              This magazine doesn&apos;t have any articles yet. Articles will
              appear here once they&apos;re added to the magazine.
            </p>
          </div>
        )}
      </div>
